                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" style="width: 25%;"> Ingredients & Measurements </th>
                            ...
                            <td class="text-center">
                                ...
                                if ($ingredients->num_rows > 0) {
                                    while ($ingredient = $ingredients->fetch_assoc()) {
                                        echo remove_junk($ingredient['name']) . " - " . (int)$ingredient['quantity'] . " " . remove_junk($ingredient['unit']) . "<br>";
                                    }
                                } else {
                                    echo '<span class="text-muted">No ingredients</span>';
                                }
                                ?>
                            </td>
                            <td class="text-center">
